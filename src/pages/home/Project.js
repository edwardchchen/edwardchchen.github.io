        ...
        <Container sx={{marginTop: "20vh"}}>
            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={4}>
                    <ProjectCard projectName={"Amazon Location Service Demo"}
                                 ...
                                 githubLink={"https://github.com/UBC-CIC/Amazon-Location-Service-Demo"}/>
                </Grid>

                <Grid item xs={12} md={4}>
                    <ProjectCard projectName={"Student Connect App"}
                                 ...
                                 externalLink={"https://cic.ubc.ca/project/ubc-okanagan-student-connect-application/"}/>
                </Grid>

                <Grid item xs={12} md={4}>
                    <ProjectCard projectName={"UBC Courses and Rooms Explorer"}
                ...
                <Grid item xs={12} md={4}>
                    <ProjectCard projectName={"NBA Stats Database"}
                ...
                <Grid item xs={12} md={4}>
                    <ProjectCard projectName={"iOS Covid-19 Dashboard"}
                                 image={covidTracker}
                                 contents={"This iOS app provides daily data on confirmed cases, deaths, and recoveries from the COVID-19 pandemic. The app allows the user to view these cases by country. It was developed using Swift 5 and has been tested on an iPhone XR running iOS 13.1"}
